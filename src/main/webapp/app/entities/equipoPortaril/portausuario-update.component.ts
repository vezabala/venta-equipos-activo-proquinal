...
@Component({
  ...
  templateUrl: './portausuario-update.component.html'
})
export class PortausuarioUpdateComponent implements OnInit {
  isSaving = false;
  ...
  ifsave(): void {
    this.modalService.open(PortausuarioGuardadoeDialogComponent, { size: 'lg', backdrop: 'static' });
  }
